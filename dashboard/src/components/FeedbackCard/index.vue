<template>
  <div class="flex flex-col px-8 py-6 rounded cursor-pointer bg-brand-gray"
    @click="handleToggle">
    ...
    <div class="flex mt-8 animate__animated animate__fadeInUp animate__faster"
      v-if="state.isOpen"
    ...
    <div class="flex justify-end mt-8"
      v-else>
      <icon name="chevronDonw" :color="brandColors.graydark" />
    </div>
  </div>
</template>
